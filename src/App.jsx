  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        {view === 'calculator' && (
          <Suspense fallback={<div className="min-h-screen flex items-center justify-center relative"><div className="scanner-line absolute inset-0" /><div className="w-7 h-7 border-2 border-[#d4a017]/20 border-t-[#d4a017] rounded-full animate-spin" /></div>}>
            <Calculator
